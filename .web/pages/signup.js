...
export default function Component() {
  ...
  {state.auth_state.year.map((wezczwfs, igqacfcr) => (
  <option key={igqacfcr} value={wezczwfs}>
  {wezczwfs}
</option>
))}
</Select>
  ...
  {state.auth_state.month.map((musmntzs, qtoureho) => (
  <option key={qtoureho} value={musmntzs}>
  {musmntzs}
</option>
))}
</Select>
  ...
  {state.auth_state.day.map((dgcibgbk, ieqszjhy) => (
  <option key={ieqszjhy} value={dgcibgbk}>
  {dgcibgbk}
</option>
))}
</Select>
